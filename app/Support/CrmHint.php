...
class CrmHint
{
    ...
    private const HINTS = [
        ...
        'homework.list' => 'Upload homework for one batch at a time. Optional WhatsApp sends each student’s Mobile a direct link to view and download (no login). Students can also open homework in the portal after login.',
        ...
        'whatsapp.templates.create' => 'Any Meta template: put {{1}}, {{2}}, … in the body — samples appear as Variable 1, Variable 2, … (edit freely for approval). Optional CRM presets: fee_reminder, homework_not_done, homework_api — leave body blank and blur the name to auto-fill.',
