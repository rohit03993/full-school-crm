...
class CrmHint
{
    ...
    private const HINTS = [
        ...
        'whatsapp.templates.create' => 'Any Meta template: put {{1}}, {{2}}, … in the body — samples appear as Variable 1, Variable 2, … (edit freely for approval). Optional CRM presets: fee_reminder, homework_not_done, homework_api, login_otp — leave body blank and blur the name to auto-fill.',
