...
class CrmHint
{
    ...
    private const HINTS = [
        ...
        'activity.sessions.list' => 'Two ways to add marks: teachers type them per subject, or you upload Excel. Then View sheet and publish. Existing exams stay in the list.',
        'activity.marks.review' => 'Mark sheet for this exam. If teachers entered marks, approve first. Excel uploads can be published when marks are in.',
        ...
        'activity.marks.import' => 'Name the exam and date, pick exam type, upload Excel. Roll numbers match students automatically.',
