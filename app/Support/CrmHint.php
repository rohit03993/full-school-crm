...
class CrmHint
{
    ...
    private const HINTS = [
        ...
        'staff.list' => 'Create logins with one or more job roles (Counsellor, Accountant, Fee adjuster, etc.). Permissions combine across selected roles.',
        'staff.create' => 'Set mobile, password, and tick every role this person needs. You can assign any combination of job roles on one account.',
        'staff.edit' => 'Add or remove job roles anytime. Super Admin is separate — full institute control. Fee adjuster is for discounts/structure without needing Super Admin.',
