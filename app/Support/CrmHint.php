...
class CrmHint
{
    ...
    private const HINTS = [
        ...
        'class_sections.list' => 'All classes/programmes and their sections in one place. Add new combinations, edit fees & subjects, or assign teachers.',
        ...
        'exam_windows.list' => 'Create exams from programme subjects. Teachers enter marks per subject; class lead submits; admin approves before publish.',
        ...
        'activity.sessions.list' => 'Upload exam marks via Excel, create exam windows from programme subjects, or schedule workshops/events.',
