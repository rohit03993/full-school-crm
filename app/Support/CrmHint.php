...
class CrmHint
{
    ...
    private const HINTS = [
        ...
        'setup.custom_fields' => 'Optional extra fields on student or enquiry forms (e.g. blood group, previous school). Not used for exam marks — use Exams → Upload Excel.',
        ...
        'setup.whatsapp' => 'Student attendance tab = student IN/OUT, WhatsApp to parents. Staff attendance tab = staff punch, WhatsApp to the staff phone. Exam marks tab = default test_marks template (staff click Send on the mark sheet). Live API campaigns are only for external POST / API key.',
        ...
        'meta_whatsapp.analytics' => 'Meta billed cost = official spend. CRM log / Cost by source / Campaigns = only messages this CRM recorded (with estimates). The Meta vs CRM coverage box shows how complete the CRM log is for the selected dates.',
        ...
        'courses.list' => 'Programme fees and details — subjects and teachers are configured separately on each section.',
        'courses.create' => 'Use a short unique code (e.g. SCH-12-SCI). Fee and duration show on the website and flow into admissions. Choose subjects when creating or editing each section.',
        'batches.list' => 'Sections within a programme — managed under Academics → Classes & sections.',
        'class_sections.list' => 'Each section has its own subjects and teachers. Open Edit section to tick subjects and assign staff beside them.',
        'class_section.create' => 'Create programme/class and section/batch together, then choose this section’s subjects and teachers.',
        'batches.create' => 'Link to a programme and academic session, choose subjects for this section, and assign staff beside each subject.',
        ...
        'staff.create' => 'Set mobile, password, and tick every role this person needs. “Can see student mobile numbers” is separate — calling staff do not see numbers unless you tick it. Super Admin alone creates accounts and changes Setup.',
        'staff.edit' => 'Add or remove job roles anytime. Tick “Can see student mobile numbers” only for people who should see full numbers and Call. Turn Active off to deactivate (history stays). Super Admin always sees numbers.',
        ...
        'certificates.page' => 'Issue TC, bonafide, character, birth, and fee certificates as PDFs. History is kept even if the module is later turned off.',
        'teaching.assignments' => 'Your class assignments and open exams — enter subject marks or submit to admin as class lead.',
        'exam_windows.list' => 'These are exams teachers type marks into. Create one from Exams, or open a row to enter marks, submit, and approve.',
        'exam_windows.create' => 'Pick the class and exam name. One mark sheet is created per subject. Teachers type marks; you publish from Exams → View sheet.',
        'exam_windows.detail' => 'Teachers enter marks per subject. Class lead submits. Approve, then View sheet to publish to parents.',
        ...
        'students.calls' => 'Service calls logged on enrolled student profiles. Filter by purpose (attendance, fees, etc.), date, or staff.',
        ...
        'courses.subjects' => 'Subjects are configured on each section so Section A and Section B can use different subject lists.',
        'courses.edit' => 'Update programme name, fee, duration, or website visibility. Configure subjects and teachers from Edit section.',
        'batches.edit' => 'Choose subjects for this section, then assign a staff teacher beside each subject. Saving here does not change another section.',
        ...
        'activity.sessions.list' => 'View sheet to review and publish. Re-uploading Excel with the same name and date updates this exam — it does not create a second one.',
        'activity.marks.review' => 'Approve teacher-entry exams first. Re-upload Excel only to correct marks on this exam.',
        ...
        'activity.marks.import' => 'Same exam name and date updates existing marks. Students in the new file are overwritten; others keep their old scores. Locked published results cannot be changed until unlocked.',
        ...
        'whatsapp.templates.create' => 'Any Meta template: put {{1}}, {{2}}, … in the body. Presets: fee_reminder_*, punch_in, punch_out, manual_in, manual_out, homework_not_done, homework_api, homework_combined, staff_punch_in, staff_punch_out, login_otp. For login_otp the CRM submits an Authentication Copy-code OTP template (Meta rejects OTP text as Utility).',
