...
class CrmHint
{
    ...
    private const HINTS = [
        ...
        'exam_windows.detail' => 'Subject-by-subject typing for this class. Open a subject to edit that paper. View sheet is the full grid and publish.',
        ...
        'activity.marks.review' => 'Update Excel for a class file, or change one student from their profile. Unlock published results first.',
