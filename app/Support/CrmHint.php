...
class CrmHint
{
    ...
    private const HINTS = [
        ...
        'setup.whatsapp' => 'Student attendance tab = student IN/OUT, WhatsApp to parents. Staff attendance tab = staff punch, WhatsApp to the staff phone. Live API campaigns are only for external POST / API key.',
