...
class CrmHint
{
    ...
    private const HINTS = [
        ...
        'batches.list' => 'A batch groups students under one course and session — e.g. Class 12-A Morning or JEE Evening Batch. Use Add class & section for the fastest setup.',
        'class_section.create' => 'Create programme/class and section/batch together — e.g. Class 12 + Section A. Existing Courses and Batches screens still work for advanced edits.',
        ...
        'assigned.to.me' => 'Your pending work — campus meetings to close and calls assigned to you.',
        'teaching.assignments' => 'Classes and subjects assigned to you as lead teacher or subject teacher. Mark entry opens here in a later update.',
        ...
        'courses.edit' => 'Update programme name, fee, duration, or website visibility. Code should stay unique. Subjects here apply to every section/batch under this programme.',
        'batches.edit' => 'Change batch name, shift, trainer, or status. Active batches appear in assign-batch and attendance. Staff assignments are optional.',
