...
class AttendanceDisplayController extends Controller
{
    ...
    public function show(Request $request): View
    {
        ...
        return view('display.attendance', [
            ...
            'cardDurationMs' => max(2000, (int) config('attendance_display.card_duration_ms', 5000)),
            'cardQueueDurationMs' => max(1500, (int) config('attendance_display.card_queue_duration_ms', 2500)),
