...
class StudentSearchService
{
    ...
    public function search(
        ...
        if (filled($mobile)) {
            ...
            $this->classAssignments->constrainStudentsQuery($student, $viewer);
        ...
        if (filled($enquiryNumber)) {
            ...
            if ($enquiry?->student && $this->classAssignments->canViewStudent($viewer, $enquiry->student)) {
        ...
        if (filled($enrollment)) {
            ...
            if ($enrollmentRecord?->student && $this->classAssignments->canViewStudent($viewer, $enrollmentRecord->student)) {
        ...
        if (filled($name)) {
            ...
            $this->classAssignments->constrainStudentsQuery($students, $viewer);
            $students = $students
                ->orderBy('name')
     ...
     */
    public function quickSearch(string $term, int $limit = 8, ?User $viewer = null): Collection
    {
        ...
        $this->classAssignments->constrainStudentsQuery($query, $viewer);
