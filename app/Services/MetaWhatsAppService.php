...
class MetaWhatsAppService
{
    ...
    /**
     * @param  list<string>  $bodyParams
     * @param  list<string>  $parameterNames  Named Meta variables (e.g. student_name). Empty = positional {{1}} {{2}}.
    ...
    /**
     * Named-parameter templates require `parameter_name` on each body value.
     * Positional templates ({{1}}, {{2}}) return [] and keep the old payload shape.
     *
     * @return list<string>
     */
