        ...
        <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
            <div class="lg:col-span-2">
                <div class="flex items-center gap-3">
                    <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-500 text-sm font-bold text-white">FI</div>
                ...
                <p class="mt-4 max-w-md text-sm leading-relaxed text-navy-300">
                    {{ $institute['tagline'] }}. Shaping hospitality professionals for a global career.
                </p>
            </div>
