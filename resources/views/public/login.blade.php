    ...
    <section class="bg-navy-50 py-16 sm:py-24">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 grid gap-6 sm:grid-cols-2">
                <div class="flex flex-col rounded-3xl border border-navy-100 bg-white p-8 shadow-sm transition hover:border-brand-300 hover:shadow-lg">
                    <a href="{{ $staffLoginUrl }}" class="group flex flex-1 flex-col">
