@php
    ...
    $steps = [
        ...
        [
            'title' => '6. Classes & sections',
            'body' => 'Add each class/programme with its sections — fee, subjects, and teachers in one place.',
            'menu' => 'Academics → Classes & sections',
            'url' => \App\Filament\Pages\ClassSectionsPage::getUrl(),
            'done' => null,
        ],
        [
            'title' => '7. Receipts & PDF logo',
        ...
        [
            'title' => '9. Fee reminders (optional)',
