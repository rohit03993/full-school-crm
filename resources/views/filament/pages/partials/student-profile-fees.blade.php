                    ...
                    @if ($collectible > 0)
                        ...
                        @if ($canCollectFees ?? false)
                            @if (\App\Support\FeatureGate::enabled(\App\Enums\LicenseFeature::WhatsApp))
                                <button
                                    type="button"
                                    wire:click="mountAction('sendFeeReminder')"
                                    class="mt-3 inline-flex items-center rounded-xl bg-orange-500/20 px-3 py-2 text-xs font-semibold text-orange-100 ring-1 ring-orange-400/40 hover:bg-orange-500/30"
                                >
                                    Send fee reminder
                                </button>
                            @endif
