@php
    ...
    $statIcons = [
        ...
        'Fees due' => 'M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z',
        'HW Not Done (week)' => 'M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25',
        ...
        <div class="fi-student-profile-dossier-stats grid grid-cols-2 gap-2 sm:gap-2">
            @foreach ($items as $counter)
                @php
                    ...
                    $isAlert = (bool) ($counter['alert'] ?? false);
                    $isAttendanceOk = ($counter['label'] ?? '') === 'Attendance'
                ...
                @if ($tab)
                    <button
                        type="button"
                        wire:click="openActivityTimelineTab(@js($tab))"
                        @class($tileClass)
                    >
                @else
                    <div @class($tileClass)>
                @endif
                    ...
                    <div class="min-w-0">
                        ...
                        <p @class([
                            'truncate text-sm font-bold text-gray-950 dark:text-white',
                            'text-rose-700 dark:text-rose-300' => $isAlert,
                        ])>{{ $counter['value'] }}</p>
                    </div>
                @if ($tab)
                    </button>
