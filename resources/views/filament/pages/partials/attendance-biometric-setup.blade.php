            ...
            <li class="flex gap-3">
                ...
                <div>
                    ...
                    <p class="mt-0.5">
                        ...
                        <a href="{{ $whatsappSettingsUrl }}" class="font-semibold text-primary-600 hover:underline dark:text-primary-400">{{ \App\Support\CrmNavigation::whatsAppMenu('Automations') }}</a>.
                    </p>
                </div>
            </li>
        </ol>
