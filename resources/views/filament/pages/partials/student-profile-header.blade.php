...
<div class="fi-student-profile-shell">
    @include('filament.pages.partials.student-profile-back')
    ...
    @else
        ...
        <div class="overflow-visible rounded-2xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
